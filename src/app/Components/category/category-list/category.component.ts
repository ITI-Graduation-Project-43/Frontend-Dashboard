...
export class CategoryComponent implements OnInit {
  ...
  observer: Observer<Category[]> = {
    next: (catData: Category[]) => {
      this.categoryService.CategorydataSource.data =
        this.categoryService.categories = catData;
  ...
  displayedColumns = ['id', 'name', 'Visibility', 'Edit', 'Delete'];
  ...
  ngOnInit(): void {
    this.categoryService
      .getApprovedCategories(CategoryType.Category)
